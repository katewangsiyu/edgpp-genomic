...
than the baseline. Source: \texttt{R\_raw/cp\_baselines\_h2h/open\_targets\_*.json}.}
...
HCCP attains $\shat$-bin gap $0.054$ vs.\ $\geq 0.65$ for all three
contemporary baselines — a $12$--$17\times$ improvement, of comparable
magnitude to TraitGym Complex's $13$--$14\times$
...
dominates by $12.9$--$16.7\times$ at $K_{\mathrm{eval}} \leq 5$
...
Eq.~\eqref{eq:gap_decomp} therefore predicts the regime boundary across
two completely independent benchmarks.
...
\{5, 8, 10\}$ aligned with $K_{\mathrm{eval}}$.}
