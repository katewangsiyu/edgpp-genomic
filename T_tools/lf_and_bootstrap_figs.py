"""Generate App C L_F estimator forest plot (95% CI) from tab:LF_estimators data.

Outputs:
  papers/neurips2027_pathA/figures/fig_lf_forest.pdf

Note: fig_bootstrap_density.pdf is generated by figures/make_fig4_bootstrap_cloud.py
(corner-plot style); the deprecated 1-D histogram version that previously lived in
this file has been removed (2026-05-07) to prevent it overwriting the paper figure.
"""
